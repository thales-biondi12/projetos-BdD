...
Repositório contendo um projeto desenvolvido em SQL (MySQL), com foco em modelagem de banco de dados e consultas para análise e auditoria.

📌 Sobre

Este projeto simula o funcionamento de um sistema de gerenciamento de condomínio, incluindo controle de unidades, moradores, cobranças, pagamentos, ocorrências e reservas de áreas comuns.
